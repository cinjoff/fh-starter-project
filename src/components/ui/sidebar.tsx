...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn sidebar component uses document.cookie for state persistence
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: shadcn sidebar component — setOpenMobile is stable
